...
import com.platform.dentify.invoices.interfaces.rest.transforms.CreateInvoiceCommandFromResourceAssembler;
import com.platform.dentify.invoices.interfaces.rest.transforms.InvoiceResourceFromEntityAssembler;
...
public class InvoicesController {
    ...
    public ResponseEntity<List<InvoiceResource>> getAllInvoices() {
        var invoices = invoiceQueryService.handle(new GetAllInvoiceQuery());
        if (invoices.isEmpty()) {
            return ResponseEntity.notFound().build();
        }
